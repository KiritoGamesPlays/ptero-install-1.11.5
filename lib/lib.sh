...
# download URLs
export PANEL_DL_URL="https://github.com/pterodactyl/panel/releases/download/v1.11.5/panel.tar.gz"
export WINGS_DL_BASE_URL="https://github.com/pterodactyl/wings/releases/download/v1.11.11/wings_linux_"
export MARIADB_URL="https://downloads.mariadb.com/MariaDB/mariadb_repo_setup"
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/KiritoGamesPlays/ptero-install-1.11.5"}
